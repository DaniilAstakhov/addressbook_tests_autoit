...
namespace addressbook_tests_autoit
{
    public class GroupHelper : HelperBase
    {
        ...
        internal void Remove()
        {
            ...
            string selectedGroup = aux.ControlTreeView(GROUPWINTITLE, "", "WindowsForms10.SysTreeView32.app.0.2c908d51", "Select", "#1", "");
            aux.ControlClick(GROUPWINTITLE, "", "WindowsForms10.SysTreeView32.app.0.2c908d51");
            aux.Send("{DOWN}");
            aux.ControlClick(GROUPWINTITLE, "", "WindowsForms10.BUTTON.app.0.2c908d51"); //Нажатие по кнопке Delete
